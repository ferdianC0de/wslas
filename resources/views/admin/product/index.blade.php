...
<div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700 mt-4">
    <div class="grid grid-cols-4 gap-4 mb-4">
        ...
        <a href="{{ route('product.create') }}" class="rounded bg-green-600 dark:bg-green-600 hover:bg-green-600 dark:hover:bg-green-800">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('product.show', $product->id) }}">
                                <img width="200px" height="200px" src="{{ asset('images/produk/'.$product->product_photo) }}" alt="{{ $product->product_photo }}">
                            </a>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 flex">
                            <a href="{{ route('product.edit', $product->id) }}" class="flex justify-center items-center">
                            ...
                            <span class="w-4"></span>
                            <form class="flex justify-center items-center" action="{{ route('product.destroy', $product->id) }}" method="post">
                            @csrf
                            @method('DELETE')
