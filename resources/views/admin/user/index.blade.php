...
<div class="p-4 border-2 border-gray-200 border-solid rounded-lg dark:border-gray-700 mt-4">
    <div class="grid grid-cols-4 gap-4 mb-4">
        ...
        <a href="{{ route('user.create') }}" class="rounded bg-green-600 dark:bg-green-600 hover:bg-green-600 dark:hover:bg-green-800">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 flex">
                            <a href="{{ route('user.edit', $user->id) }}" class="flex justify-center items-center">
                            ...
                            <span class="w-4"></span>
                            <form class="flex justify-center items-center" action="{{ route('user.destroy', $user->id) }}" method="post">
                            @csrf
                            @method('DELETE')
